...
<script type="text/javascript">
	...
	function submitSearch() {
		$.get("", {
			...
			//$("#excelDataTable").append("<th/>Select<th/>Label<th/>Elevation<th/>Coor1<th/>Coor2");
	...
	<div class="row">
        <div class="col-md-6">
			...
			<button onclick="submitCheckbox('save')" >
				<i class="glyphican glyphicon-save"></i>Save
			</button>
			<button onclick="submitCheckbox('delete')" >
				<i class="glyphican glyphicon-save"></i>delete
			</button>
